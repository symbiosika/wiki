...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IdeaCardItem: typeof import('./components/idea-boards/IdeaCardItem.vue')['default']
    IdeaCardPanel: typeof import('./components/idea-boards/IdeaCardPanel.vue')['default']
